...
<div class="col-sm-3 textalign labelalign">  PRICE DATE
  <input type="text" class="form-control"  name="pricedate" id="pricedate" placeholder="DD/MM/YYYY" maxlength="50"  onBlur="return  ValidateForm()"   value="<?php echo $pricedate; ?>" /> </div>
