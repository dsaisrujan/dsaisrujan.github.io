...
<html lang="en"><head>
    <meta charset="utf-8">
 <title>SVFS :: Admin Section</title>
 ...
 <!-- header-top -->
	<div class="header-top">
		<div class="container">
			...
			<div class="agileinfo-social-link">
				<ul>
					<li><a href="login.php"><i class="fa fa-user"></i> Administrator</a></li>
                    <li><a href="../includes/logout.php"><i class="fa fa-user"></i> Logout</a></li>
		 		</ul>
			</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="administrator.php" class="hvr-sweep-to-bottom">Administrator</a></li>
								<li><a href="transactions.php" class="hvr-sweep-to-bottom">Transactions</a></li>
								<li><a href="reports.php" class="hvr-sweep-to-bottom">Reports</a></li>
