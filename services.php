	...
	<div class="header-top">
		<div class="container">
			...
			<div class="agileinfo-social-link">
				<ul>
					<li><a href="login.php"><i class="fa fa-user"></i> Employee/Credit Customer Login</a></li>
		 		</ul>
			</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="services.php" class="hvr-sweep-to-bottom">Services</a></li>
								...
								<div class="choose-right-grid col-sm-6">
									<div class="choose-info-grid ">
										<ul>
											...
											<li><a href="login.php">Credit Customer</a></li>
										</ul>
									</div>
								</div>
								<div class="clearfix"> </div>
